...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y5tijvy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y5tijvy.containers.anotherwebservice.com/
...
```
git clone git@github.com:fivayid872/container-y5tijvy.git
cd container-y5tijvy
```
...
```
docker attach container-y5tijvy
```
